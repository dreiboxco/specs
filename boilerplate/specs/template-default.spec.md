...
- **Contexto:** TODO (ex.: CLI precisa expor comandos para gestão de contas/projetos)
...
- Compatibilidade de plataforma (SO/arquitetura), versões mínimas de runtime/linguagem (se aplicável).
...
- Lista objetiva de verificações. Ex.: "`<comando> --help` exibe comandos core em <150ms", "`<comando> login --token X` retorna 0 e persiste credencial em <path>".
